...
public class AnalysisTests
{
    ...
    {
        var provider = Type(
            "Sample.OrdersProvider",
            "OrdersProvider",
            ["Paradigm.Enterprise.Providers.IProvider"]);
    ...
    {
        var controller = Type(
            "Sample.OrdersController",
            "OrdersController",
            [],
            "Paradigm.Enterprise.WebApi.Controllers.ApiControllerBase");
    ...
    {
        var controller = Type(
            "Sample.StatusController",
            "StatusController",
            [],
            "Paradigm.Enterprise.WebApi.Controllers.ApiControllerBase",
            ["Paradigm.Enterprise.WebApi.Attributes.ApiAuthorizationAttribute"]);
    ...
    public void Authorization_on_intermediate_controller_base_is_discovered()
    {
        var frameworkBase = Type(
            ...
            isAbstract: true);
        var securedBase = Type(
            "Sample.SecuredControllerBase",
            "SecuredControllerBase",
            [],
            frameworkBase.FullName,
            ["Paradigm.Enterprise.WebApi.Attributes.ApiAuthorizationAttribute"],
            isAbstract: true);
    ...
    public void Unprotected_action_on_intermediate_anonymous_base_is_reported()
    {
        var frameworkBase = Type(
            ...
            "Microsoft.AspNetCore.Mvc.ControllerBase",
            ["Microsoft.AspNetCore.Authorization.AllowAnonymousAttribute"],
            [new("Get", "public Task Get()", [])],
            isAbstract: true);
        var intermediate = Type(
            "Sample.OrdersControllerBase",
            "OrdersControllerBase",
            [],
            frameworkBase.FullName,
            actions: [new("Post", "public Task Post()", ["Paradigm.Enterprise.WebApi.Attributes.ApiAuthorizationAttribute"])],
            isAbstract: true);
    ...
    public void Capability_with_mixed_identifier_types_is_an_error()
    {
        var repository = Type(
            ...
            "OrderRepository",
            [
                "Sample.IOrderRepository",
                "Paradigm.Enterprise.Domain.Repositories.IRepository",
                "IReadRepository<Sample.Order, System.Int32>"
            ]);
        var provider = Type(
            "Sample.OrderProvider",
            "OrderProvider",
            [
                "Sample.IOrderProvider",
                "Paradigm.Enterprise.Providers.IProvider",
                "IReadProvider<Sample.OrderView, System.Guid>"
            ]);
    ...
    public void Identifier_validation_includes_entity_view_and_controller()
    {
        ...
        var controller = Type(
            ...
            "OrderController",
            [],
            "Paradigm.Enterprise.WebApi.Controllers.ReadApiControllerBase<Sample.IOrderProvider, Sample.OrderView, Sample.Parameters, System.Int32>");
    ...
    private static InspectedType Type(
        ...
        IReadOnlyList<InspectedAction>? actions = null,
        bool isAbstract = false) =>
        new(fullName, name, "Sample", baseType, interfaces, attributes ?? [], [], actions ?? [], true, isAbstract, "Sample", null, null);
}
