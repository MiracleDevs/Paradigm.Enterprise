    ...
    public void GenerateMapperCode(Type[] genericArguments, List<string> generatedTypes)
    {
        foreach (var genericArgument in genericArguments)
        {
            ...
            foreach (var property in targetType.GetProperties())
                GenerateNpgsqlParameterMapperPropertyAssignments(propertyAssignments, property, targetType.Name);
...
internal partial class {mapperClassName} : NpgsqlParameterMapperBase
{{
...
{propertyAssignments}
    ...
    /// <summary>
    /// Generates the NPGSQL parameter mapper property assignments.
    /// </summary>
    ...
    private void GenerateNpgsqlParameterMapperPropertyAssignments(StringBuilder propertyAssignments, PropertyInfo property, string targetTypeName)
    {
        ...
        if (generateDataTableParameter || generateSingleRowDataTableParameter)
        {
            ...
            propertyAssignments.AppendLine($"        AddNpgsqlParameter(nameof({targetTypeName}.{propertyName}), instance.{propertyName});");
    }
}
