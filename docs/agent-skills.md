...
Use `paradigm-evolve-guidance` when a repeatable review lesson should become a fixture, built-in rule, explicit process check, reviewed dry-run fixer, or concise judgment-only instruction. Prefer deterministic enforcement whenever stable evidence exists.
