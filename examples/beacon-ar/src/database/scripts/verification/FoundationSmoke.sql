...
IF OBJECT_ID(N'[dbo].[QuotePricingView]', N'V') IS NULL THROW 51000, 'QuotePricingView is missing.', 1;
...
IF OBJECT_ID(N'[dbo].[SalesOrderPricingView]', N'V') IS NULL THROW 51000, 'SalesOrderPricingView is missing.', 1;
IF OBJECT_ID(N'[dbo].[AuditLogView]', N'V') IS NULL THROW 51000, 'AuditLogView is missing.', 1;
IF OBJECT_ID(N'[dbo].[IdempotencyRequestView]', N'V') IS NULL THROW 51000, 'IdempotencyRequestView is missing.', 1;
IF OBJECT_ID(N'[dbo].[IdempotencyStateView]', N'V') IS NULL THROW 51000, 'IdempotencyStateView is missing.', 1;
IF EXISTS
(
    SELECT 1
    FROM
    (
        VALUES
            ...
            (N'SalesOrderPricingView'),
            (N'AuditLogView'),
            (N'IdempotencyRequestView'),
            (N'IdempotencyStateView')
...
THROW 51000, 'A database view is not schema-bound.', 1;
...
IF EXISTS (SELECT [QuoteId] FROM [dbo].[QuotePricingView] GROUP BY [QuoteId] HAVING COUNT_BIG(*) > 1) THROW 51000, 'QuotePricingView duplicates quote rows.', 1;
...
IF EXISTS (SELECT [SalesOrderId] FROM [dbo].[SalesOrderPricingView] GROUP BY [SalesOrderId] HAVING COUNT_BIG(*) > 1) THROW 51000, 'SalesOrderPricingView duplicates sales-order rows.', 1;
IF EXISTS (SELECT [Id] FROM [dbo].[AuditLogView] GROUP BY [Id] HAVING COUNT_BIG(*) > 1) THROW 51000, 'AuditLogView duplicates base rows.', 1;
IF EXISTS (SELECT [Id] FROM [dbo].[IdempotencyRequestView] GROUP BY [Id] HAVING COUNT_BIG(*) > 1) THROW 51000, 'IdempotencyRequestView duplicates base rows.', 1;
IF EXISTS (SELECT [Id] FROM [dbo].[IdempotencyStateView] GROUP BY [Id] HAVING COUNT_BIG(*) > 1) THROW 51000, 'IdempotencyStateView duplicates base rows.', 1;
IF (SELECT COUNT_BIG(*) FROM [dbo].[AuditLog]) <> (SELECT COUNT_BIG(*) FROM [dbo].[AuditLogView]) THROW 51000, 'AuditLogView base-row count mismatch.', 1;
IF (SELECT COUNT_BIG(*) FROM [dbo].[IdempotencyRequest]) <> (SELECT COUNT_BIG(*) FROM [dbo].[IdempotencyRequestView]) THROW 51000, 'IdempotencyRequestView base-row count mismatch.', 1;
IF (SELECT COUNT_BIG(*) FROM [dbo].[IdempotencyState]) <> (SELECT COUNT_BIG(*) FROM [dbo].[IdempotencyStateView]) THROW 51000, 'IdempotencyStateView base-row count mismatch.', 1;
