...
public sealed class BeaconArDocumentFilter : IDocumentFilter
{
    ...
    private static void ConfigureRequestSchemas(IDictionary<string, IOpenApiSchema> schemas)
    {
        ...
        SetNullable(schemas, "SalesOrderSummaryDto", "sourceQuoteId", "requestedShipDate", "carrierId", "carrierName", "trackingNumber", "createdByUserId", "modifiedByUserId", "modificationDate");
    }
    ...
    private static void ConfigureSchemaExamples(IDictionary<string, IOpenApiSchema> schemas)
    {
        IReadOnlyDictionary<string, JsonNode> examples = new Dictionary<string, JsonNode>(StringComparer.Ordinal)
        {
            ...
            ["QuoteSummaryDto"] = ParseExample("""{"id":91,"quoteNumber":"Q-2026-000091","customerId":42,"customerAccountNumber":"ACME-001","customerName":"Acme Distribution","quoteDate":"2026-08-01","validUntil":"2026-08-31","status":"sent","subtotal":99.90,"discountTotal":5.00,"grandTotal":94.90,"salesOrderId":null,"createdByUserId":42,"creationDate":"2026-08-01T15:30:00Z","modifiedByUserId":null,"modificationDate":null,"version":"AQIDBAUGBwg="}"""),
            ["SalesOrderSummaryDto"] = ParseExample("""{"id":101,"orderNumber":"SO-2026-000101","sourceQuoteId":91,"customerId":42,"customerAccountNumber":"ACME-001","customerName":"Acme Distribution","status":"draft","requestedShipDate":"2026-08-15","carrierId":3,"carrierName":"United Parcel Service","trackingNumber":"1Z999AA10123456784","subtotal":99.90,"discountTotal":5.00,"grandTotal":94.90,"createdByUserId":42,"creationDate":"2026-08-01T15:30:00Z","modifiedByUserId":null,"modificationDate":null,"version":"AQIDBAUGBwg="}"""),
        };
