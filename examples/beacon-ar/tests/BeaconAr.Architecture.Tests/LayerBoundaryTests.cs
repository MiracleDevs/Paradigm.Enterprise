...
public sealed class LayerBoundaryTests
{
    ...
    {
        var root = FindExampleRoot();
        var quoteBehavior = File.ReadAllText(Path.Combine(root, "src", "BeaconAr.Domain", "Sales", "Quote.Behavior.cs"));
        var orderBehavior = File.ReadAllText(Path.Combine(root, "src", "BeaconAr.Domain", "Sales", "SalesOrder.Behavior.cs"));
    ...
    public void GeneratedViewsAreKeylessDatabaseProjectionsAndContextUsesParadigmBase()
    {
        ...
        [
            ...
            typeof(QuotePricingView), typeof(SalesOrderPricingView), typeof(AuditLogView), typeof(IdempotencyRequestView),
            typeof(IdempotencyStateView),
        ];
        foreach (Type viewType in generatedViews)
        {
